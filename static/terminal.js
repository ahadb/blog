...
function init() {
  ...
  setTimeout(addLine, step * 0, '-rw-r--r--', 'Jun 25 2015', 'Isomorphic JavaScript');
  setTimeout(addLine, step * 1, '-rw-r--r--', 'Sep 01 2014', 'React Single Page Apps');
  setTimeout(addLine, step * 2, '-rw-r--r--', 'Jul 14 2014', 'Node Express Mongodb');
  setTimeout(addLine, step * 3, '-rw-r--r--', 'Apr 21 2014', 'FinTech');
  setTimeout(addLine, step * 4, '-rw-r--r--', 'Jan 12 2013', 'Best Systems, Tools');
}

var months = 'Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec'.split(' ');
var years = '2012 2013 2014 2015'.split(' ')
var words = [
  'Awesome',
  'Badger',
  'GPU',
